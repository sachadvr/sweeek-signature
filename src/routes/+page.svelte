...
{#if banner}
<div class="flex gap-3 banner bg-green-300 text-black p-4 font-bold text-4xl max-md:text-3xl fixed w-full top-0 transition-all animate"><Fa icon={faCheck} />  {banner}</div>
{/if}
...
<div class="signature">
  ...
  <td style="padding: 0 1rem;">
      ...
      <div class="label" style="text-decoration: none; color: white;">{email}</div>
      <div class="label" style="text-decoration: none; color: white;">{phone}</div>
  </td>
